...
CQSVGPathBezier3To::
CQSVGPathBezier3To(CQSVG &svg, double x1, double y1, double x2, double y2, double x3, double y3) :
...
CQSVGPathRBezier3To::
CQSVGPathRBezier3To(CQSVG &svg, double x1, double y1, double x2, double y2, double x3, double y3) :
